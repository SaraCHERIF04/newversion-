...
import  MaitreOuvrageService  from '@/services/MaitreOuvrageService';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            />
                     ...
                     <div>
      <Label htmlFor="maitreOuvrage" className="mb-2 block">
        Maître d'ouvrage
      </Label>
      <div className="flex gap-2">
        <Select value={selectedMaitreOuvrage?.toString() || ''} onValueChange={(value) => setSelectedMaitreOuvrage(value)}>
          <SelectTrigger className="w-full">
