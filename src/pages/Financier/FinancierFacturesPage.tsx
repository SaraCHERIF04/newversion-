  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => navigate('/financier/factures/new')}>
          Créer nouveau
        </Button>
      </div>
                ...
                <TableCell className="text-right">
                  <div className="flex justify-end gap-2">
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => navigate(`/financier/factures/${invoice.id}`)}
                    >
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => navigate(`/financier/factures/edit/${invoice.id}`)}
                    >
...
export default FinancierFacturesPage;
